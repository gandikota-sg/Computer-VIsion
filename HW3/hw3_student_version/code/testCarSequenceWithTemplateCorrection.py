...
for i in range(frame-1):
    ...
    if i == 0 or i == 99 or i == 199 or i == 299 or i == 399:
        ...
        plt.savefig('../results/CarCorrectionFrame_' + str(i + 1)+'.png', bbox_inches='tight')

np.save('carseqrects-wcrt.npy', box_array)
